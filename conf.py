...
html_extra_path = ['resume', 'projects/arduino-uno/pdfs', 'projects/ISL6236A/pdfs', 'analog-sensor-systems/strain-gage/pdf', 'analog-sensor-systems/TIA/pdf']
html_favicon = ''
html_logo = 'logo.png'
...
mathjax3_config = {'chtml': {'scale': 0.85}}
