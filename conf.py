...
mathjax3_config = {'HTML-CSS': {'scale': 85, 'availableFonts': ['STIX', 'TeX'], 'preferredFont': 'TeX', 'webFont': 'TeX', 'imageFont': 'TeX', 'mtextFontInherit': False, 'matchFontHeight': False}}
